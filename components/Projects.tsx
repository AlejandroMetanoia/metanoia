...
const Projects: React.FC = () => {
    ...
    return (
        <section id="proyectos" className="h-screen scroll-mt-24 bg-gray-50 border-b border-silver-100 overflow-hidden flex flex-col justify-center relative">
            ...
            <div
                ...
                className="flex overflow-x-auto gap-8 px-6 pb-4 snap-x snap-mandatory no-scrollbar flex-shrink-0"
